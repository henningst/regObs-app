 ...
 * 
 * @param key
 *            The name of the tracked item (can be a url or some logical name).
 ...
 * 
 * @param category
 *            The name that you supply as a way to group objects that you want
 *            to track
 * @param action
 *            The name the type of event or interaction you want to track for a
 *            particular web object
 * @param label
 *            Provides additional information for events that you want to track
 *            (optional)
 * @param value
 *            Assign a numerical value to a tracked page object (optional)
 * 
 * @param successCallback
 *            The success callback
 * @param failureCallback
