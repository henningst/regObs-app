var ice_see_obs = {
	...
	init: function(){
		...
		geo.requestPosition("ice_see_obs.loadObservations");
	...
	loadObservations : function(position){
		ice_see_obs.setPosAndUpdateObservations.call(ice_see_obs, position);
	}
};

jQuery.extend(ice_see_obs, super_observations);
