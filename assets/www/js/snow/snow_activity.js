var snow_activity = {
		...
		init: function() {
			...
			if(jQuery('#snow_activity_carusel_count').html() === ""){
			...
			if(jQuery('#snow_activity_carusel_size').html() === ""){
			...
			if(jQuery('#snow_activity_carusel_type').html() === ""){
