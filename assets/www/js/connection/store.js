...
NveStore = (function() {
  ...
  NveStore.prototype.sendSnow = function(callback) {
    if (this.m_snowStore) this.m_snowStore.send();
  ...
  NveStore.prototype.sendDirt = function(callback) {
    if (this.m_dirtStore) this.m_dirtStore.send();
    if (callback) return callback();
  };
  ...
  NveStore.prototype.sendIce = function(callback) {
    if (this.m_iceStore) this.m_iceStore.send();
    if (callback) return callback();
  };
  ...
  NveStore.prototype.sendWater = function(callback) {
    if (this.m_waterStore) this.m_waterStore.send();
    if (callback) return callback();
  };
