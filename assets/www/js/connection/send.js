...
var GetObjectFromServer, LoggedInAs, Login, Logout, ObservationUrl, SendObjectToServer;
...
ObservationUrl = function(hazard, regionId) {
  return "http://www.regobs.no/Search/SearchMobile?GeoHazard=" + hazard + "&SelectedTypes=-1&SelectedRegions=" + regionId + "&SelectedPeriode=2";
};
