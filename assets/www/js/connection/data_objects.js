...
var ActivityInfluencedKD, ActivityInfluencedW, AllRegistrationsV, AreaInformation, AreaUsageKD, AutoCastable, AvalCauseExtKD, AvalCauseKD, AvalProbabilityKD, AvalReleaseHeightKD, AvalTriggerSimpleKD, AvalancheActivityObs, AvalancheActivityObsV, AvalancheDangerKD, AvalancheDangerObs, AvalancheDangerObsV, AvalancheEvalProblem, AvalancheEvaluation, AvalancheEvaluation2, AvalancheEvaluationV, AvalancheExtKD, AvalancheKD, AvalancheObs, AvalancheProblemKD, AvalancheProblemMenu1V, AvalancheProblemMenu2V, AvalanchePublisherKD, AvalancheTriggerKD, AvalancheWarning, AvalancheWarningInternalCommentsV, AvalancheWarningNoV, AvalancheWarningObsLocation, AvalancheWarningPublishedSummaryV, AvalancheWarningSummaryV, AvalancheWarningV, Competancy, CompetenceLevelKD, CompetenceLevelW, ComprTestFractureKD, CompressionTest, CompressionTestKD, County, CriticalLayerKD, DamageExtentKD, DangerObs, DangerSignKD, DestructiveSizeExtKD, DestructiveSizeKD, EstimatedNumKD, EventedModel, ForecastAccurateKD, ForecastRegionKD, ForecastRegionW, GeoHazardKD, Group, IceCoverBeforeKD, IceCoverKD, IceCoverObs, IceLayerKD, IceThickness, IceThicknessLayer, Incident, IncidentNoV, IncidentURLs, IncidentV, LandSlideKD, LandSlideObs, LandSlideSizeKD, LandSlideTriggerKD, Language, ObsLocation, ObsLocationV, Observation, Observer, ObserverCompetancy, ObserverGroup, ObserverGroupMember, ObserverGroupMemberV, ObserverGroupObsLocationV, ObserverHazardsComp, ObserverHazardsCompW, ObserverLocationV, Picture, PictureV, PositionDetails, PrecipitationKD, PropagationKD, RegineDetails, Registration, RegistrationKD, Result, SendEmail, SnowCoverObs, SnowCoverObsNoV, SnowCoverObsV, SnowDriftKD, SnowSurfaceKD, SnowSurfaceObservation, SnowSurfaceObservationV, StabilityEvalKD, SurfaceRoughnessKD, SurfaceWaterContentKD, TerrainStartZoneKD, UTMSourceKD, UsageFlagKD, User, WaterLevel, WaterLevelRefKD, WeatherObservation, WeatherObservationV,
...
RegineDetails = (function() {

  RegineDetails.prototype.url = "";

  function RegineDetails(Lat, Long) {
    this.Lat = Lat;
    this.Long = Long;
    this.url = "http://gis.nve.no/ArcGIS/rest/services/Mapservices/Hydrografi/MapServer/2/query?text=&geometry=" + this.Long + "," + this.Lat + "&geometryType=esriGeometryPoint&inSR=32633&spatialRel=esriSpatialRelIntersects&relationParam=&objectIds=&where=&time=&returnCountOnly=false&returnIdsOnly=false&returnGeometry=false&maxAllowableOffset=&outSR=&outFields=*&f=pjson";
  }

  return RegineDetails;
...
AvalProbabilityKD = (function() {

  AvalProbabilityKD.prototype.url = null;

  function AvalProbabilityKD(AvalProbabilityTID, LangKey, AvalProbabilityName, AvalProbabilityDescr) {
    this.AvalProbabilityTID = AvalProbabilityTID;
    this.LangKey = LangKey;
    this.AvalProbabilityName = AvalProbabilityName;
    this.AvalProbabilityDescr = AvalProbabilityDescr;
    this.url = "" + SERVER_URL + "AvalProbabilityKD?$filter=LangKey eq " + LANGUAGE;
  }

  return AvalProbabilityKD;

})();

AvalTriggerSimpleKD = (function() {

  AvalTriggerSimpleKD.prototype.url = null;

  function AvalTriggerSimpleKD(AvalTriggerSimpleTID, LangKey, AvalTriggerSimpleName, AvalTriggerSimpleDescr) {
    this.AvalTriggerSimpleTID = AvalTriggerSimpleTID;
    this.LangKey = LangKey;
    this.AvalTriggerSimpleName = AvalTriggerSimpleName;
    this.AvalTriggerSimpleDescr = AvalTriggerSimpleDescr;
    this.url = "" + SERVER_URL + "AvalTriggerSimpleKD?$filter=LangKey eq " + LANGUAGE;
  }

  return AvalTriggerSimpleKD;

})();

DestructiveSizeExtKD = (function() {

  DestructiveSizeExtKD.prototype.url = null;

  function DestructiveSizeExtKD(DestructiveSizeExtTID, LangKey, DestructiveSizeExtName, DestructiveSizeExtDescr) {
    this.DestructiveSizeExtTID = DestructiveSizeExtTID;
    this.LangKey = LangKey;
    this.DestructiveSizeExtName = DestructiveSizeExtName;
    this.DestructiveSizeExtDescr = DestructiveSizeExtDescr;
    this.url = "" + SERVER_URL + "DestructiveSizeExtKD?$filter=LangKey eq " + LANGUAGE;
  }

  return DestructiveSizeExtKD;

})();

AvalReleaseHeightKD = (function() {

  AvalReleaseHeightKD.prototype.url = null;

  function AvalReleaseHeightKD(AvalReleaseHeightTID, LangKey, AvalReleaseHeighName, AvalReleaseHeighDescr) {
    this.AvalReleaseHeightTID = AvalReleaseHeightTID;
    this.LangKey = LangKey;
    this.AvalReleaseHeighName = AvalReleaseHeighName;
    this.AvalReleaseHeighDescr = AvalReleaseHeighDescr;
    this.url = "" + SERVER_URL + "AvalReleaseHeightKD?$filter=LangKey eq " + LANGUAGE;
  }

  return AvalReleaseHeightKD;

})();

AvalancheExtKD = (function() {

  AvalancheExtKD.prototype.url = null;

  function AvalancheExtKD(AvalancheExtTID, LangKey, AvalancheExtName, AvalancheExtDescr) {
    this.AvalancheExtTID = AvalancheExtTID;
    this.LangKey = LangKey;
    this.AvalancheExtName = AvalancheExtName;
    this.AvalancheExtDescr = AvalancheExtDescr;
    this.url = "" + SERVER_URL + "AvalancheExtKD?$filter=LangKey eq " + LANGUAGE;
  }

  return AvalancheExtKD;

})();

AvalCauseKD = (function() {

  AvalCauseKD.prototype.url = null;

  function AvalCauseKD(AvalCauseTID, LangKey, AvalCauseName, AvalCauseDescr) {
    this.AvalCauseTID = AvalCauseTID;
    this.LangKey = LangKey;
    this.AvalCauseName = AvalCauseName;
    this.AvalCauseDescr = AvalCauseDescr;
    this.url = "" + SERVER_URL + "AvalCauseKD?$filter=LangKey eq " + LANGUAGE;
  }
...
AvalCauseExtKD = (function() {

  AvalCauseExtKD.prototype.url = null;

  function AvalCauseExtKD(AvalCauseExtTID, LangKey, AvalCauseExtName, AvalCauseExtDescr) {
    this.AvalCauseExtTID = AvalCauseExtTID;
    this.LangKey = LangKey;
    this.AvalCauseExtName = AvalCauseExtName;
    this.AvalCauseExtDescr = AvalCauseExtDescr;
    this.url = "" + SERVER_URL + "AvalCauseExtKD?$filter=LangKey eq " + LANGUAGE;
  }

  return AvalCauseExtKD;

})();

AvalancheProblemMenu1V = (function() {

  AvalancheProblemMenu1V.prototype.url = null;

  function AvalancheProblemMenu1V() {
    this.url = "" + SERVER_URL + "AvalancheProblemMenu1V?$filter=LangKey eq " + LANGUAGE;
  }

  return AvalancheProblemMenu1V;

})();

AvalancheProblemMenu2V = (function() {

  AvalancheProblemMenu2V.prototype.url = null;

  function AvalancheProblemMenu2V() {
    this.url = "" + SERVER_URL + "AvalancheProblemMenu2V?$filter=LangKey eq " + LANGUAGE;
  }

  return AvalancheProblemMenu2V;
...
AvalancheEvaluation2 = (function(_super) {

  __extends(AvalancheEvaluation2, _super);

  AvalancheEvaluation2.prototype.url = function() {
    return "" + SERVER_URL + "AvalancheEvaluation2";
  };

  function AvalancheEvaluation2(RegID, AvalancheEvaluation, AvalancheDevelopment, ValidExposition, ExposedHeight1, ExposedHeight2, ExposedHeightComboTID, ExposedClimateTID, AvalancheDangerTID, UsageFlagTID) {
    this.RegID = RegID;
    this.AvalancheEvaluation = AvalancheEvaluation;
    this.AvalancheDevelopment = AvalancheDevelopment;
    this.ValidExposition = ValidExposition;
    this.ExposedHeight1 = ExposedHeight1;
    this.ExposedHeight2 = ExposedHeight2;
    this.ExposedHeightComboTID = ExposedHeightComboTID;
    this.ExposedClimateTID = ExposedClimateTID;
    this.AvalancheDangerTID = AvalancheDangerTID;
    this.UsageFlagTID = UsageFlagTID;
    this.model = "AvalancheEvaluation2";
  }

  return AvalancheEvaluation2;
...
IceCoverObs = (function(_super) {

  __extends(IceCoverObs, _super);

  IceCoverObs.prototype.url = function() {
    return "" + SERVER_URL + "IceCoverObs";
  };

  function IceCoverObs(RegID, IceCoverBeforeTID, IceCoverTID, UsageFlagTID, Comment) {
    this.RegID = RegID;
    this.IceCoverBeforeTID = IceCoverBeforeTID;
    this.IceCoverTID = IceCoverTID;
    this.UsageFlagTID = UsageFlagTID;
    this.Comment = Comment;
    this.model = "IceCoverObs";
  }
...
AvalancheEvalProblem = (function(_super) {

  __extends(AvalancheEvalProblem, _super);

  AvalancheEvalProblem.prototype.url = function() {
...
IceCoverBeforeKD = (function() {

  IceCoverBeforeKD.prototype.url = null;

  function IceCoverBeforeKD(IceCoverBeforeTID, LangKey, IceCoverBeforeName, IceCoverBeforeDescr) {
    this.IceCoverBeforeTID = IceCoverBeforeTID;
    this.LangKey = LangKey;
...
IceCoverKD = (function() {
  ...
  IceCoverKD.prototype.url = null;

  function IceCoverKD(IceCoverTID, LangKey, IceCoverName, IceCoverDescr) {
    this.IceCoverTID = IceCoverTID;
    this.LangKey = LangKey;
